package com.transfer.flash.persistence
...
/**
 * Keystore-wrapped SQLCipher passphrase (C1.4).
 *
 ...
 */
class KeystorePassphraseProvider(context: Context) : PassphraseProvider {
    ...
    override fun passphrase(): ByteArray {
        ...
        if (stored != null) {
            ...
            // Corrupt/rotated wrapper: fall through and re-seed. The DB would then fail to open
            // with the old ciphertext — acceptable for the dev DB; production upgrades preserve it.
        }
