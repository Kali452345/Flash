...
class TransferReconnectResumePolicyTest {
    ...
    fun aBrokenSourceStopsReOfferingAfterTheCap() {
        ...
        repeat(3) { attempt ->
            assertEquals(1, policy.onPeerSessionUp(PEER, stuck).size, "attempt ${attempt + 1} should still be allowed")
        }
        repeat(5) {
    ...
    fun anAttemptThatMovedBytesEarnsTheNextOne() {
        ...
        repeat(10) { roam ->
            ...
            assertEquals(listOf(FlashTransferId("big")), resumed, "roam $roam should resume")
