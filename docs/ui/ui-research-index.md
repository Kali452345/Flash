...
| UI-050 | Calling UI (voice/video call screen) | [calling-ui.md](calling-ui.md) | DESIGNED (implementation in progress; `:core:calling` + `:ui:calling`, ADR-025) | UI-001, UI-002, UI-033, UI-037, UI-038 |
